<?php
  ...
  * Slug: fitness-fse/section-title-two
...
<h2 class="has-text-align-center animated animated-fadeInUp has-slider-title-font-size" style="line-height:1.3"><?php echo esc_html__( 'Section Main Title Here', 'fitness-fse' ); ?></h2>
<!-- /wp:heading --></div>
<!-- /wp:group -->
